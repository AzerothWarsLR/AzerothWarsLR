...
library QuestMalfurionAwakens initializer OnInit requires QuestData, DruidsConfig
  ...
  private function OnInit takes nothing returns nothing
    ...
    set QUEST_MALFURION = QuestData.create("Awakening of Stormrage", "Ever since the War of the Ancients, Malfurion Stormrage and his druids have slumbered within the Barrow Den for ten thousand years. Now, their help may be required more than ever.", "Malfurion has emerged from his deep slumber in the Barrow Den", "ReplaceableTextures\\CommandButtons\\BTNFurion.blp")
