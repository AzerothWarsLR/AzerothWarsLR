library QuestItemLegendReachRect requires QuestItemData, Legend, Environment
  ...
  struct QuestItemLegendReachRect extends QuestItemData
    ...
    private static method onInit takes nothing returns nothing
      call TriggerAddAction(thistype.entersRectTrig, function QuestItemLegendReachRect.OnAnyRegionEnter)
    endmethod
  endstruct
