library GilneasFrontSetup requires Faction, TeamSetup

  globals
    Faction FACTION_GILNEASFRONT
  endglobals

  public function OnInit takes nothing returns nothing
    local Faction f
    
    set FACTION_GILNEASFRONT = Faction.create("Rebellion", PLAYER_COLOR_COAL, "|cff808080", "ReplaceableTextures\\CommandButtons\\BTNHeroPaladin.blp", 2)
    set f = FACTION_GILNEASFRONT
