library AhnqirajSetup requires Faction, TeamSetup

    globals
        Faction FACTION_AHNQIRAJ
    endglobals

    public function OnInit takes nothing returns nothing
     local Faction f   
     set FACTION_AHNQIRAJ = Faction.create("Ahn'qiraj", PLAYER_COLOR_WHEAT, "|cFFFFDF80","ReplaceableTextures\\CommandButtons\\BTNCthunIcon.blp", 5)
