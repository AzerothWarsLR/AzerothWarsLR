...
library QuestMograine requires LordaeronSetup, LegendLordaeron, QuestItemLegendDead
  ...
  struct QuestMograine extends QuestData
    ...
    public static method create takes nothing returns thistype
      local thistype this = thistype.allocate("The Scarlet Crusade", "The Lich King, looming over Northrend from Icecrown's peak, is the greatest threat Lordaeron has ever faced. He must be destroyed.", "ReplaceableTextures\\CommandButtons\\BTNAlexandros.blp")
