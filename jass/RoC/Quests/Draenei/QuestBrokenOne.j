library QuestBrokenOne requires QuestData, DraeneiSetup
  ...
  struct QuestBrokenOne extends QuestData
    ...
    public static method create takes nothing returns thistype
      ...
      call this.AddQuestItem(QuestItemEitherOf.create(QuestItemLegendNotPermanentlyDead.create(LEGEND_EXODARSHIP), QuestItemControlPoint.create(ControlPoint.ByUnitType('n09X'))))
