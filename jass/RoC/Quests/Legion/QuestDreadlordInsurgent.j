...
library QuestDreadlordInsurgent requires LegionSetup, LegendLegion, Display
  ...
  struct QuestDreadlordInsurgent extends QuestData
    ...
    private method OnComplete takes nothing returns nothing
      ...
      call CreateUnits(this.Holder.Player, 'hkni', GetRectCenterX(gg_rct_Vandermar_Village), GetRectCenterY(gg_rct_Vandermar_Village), 270, 12)
      call CreateUnits(this.Holder.Player, 'hpea', GetRectCenterX(gg_rct_Vandermar_Village), GetRectCenterY(gg_rct_Vandermar_Village), 270, 6)
      call CreateUnits(this.Holder.Player, 'hfoo', GetRectCenterX(gg_rct_Vandermar_Village), GetRectCenterY(gg_rct_Vandermar_Village), 270, 12)
      call CreateUnits(this.Holder.Player, 'h009', GetRectCenterX(gg_rct_Vandermar_Village), GetRectCenterY(gg_rct_Vandermar_Village), 270, 2)
