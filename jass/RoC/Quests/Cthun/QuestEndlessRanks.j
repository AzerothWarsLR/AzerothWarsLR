library QuestEndlessRanks requires QuestData, QuestItemKillUnit
  ...
  struct QuestEndlessRanks extends QuestData
    ...
    public static method create takes nothing returns thistype
      ...
      call this.AddQuestItem(QuestItemTrain.create('o02N', 24))
      call this.AddQuestItem(QuestItemTrain.create('n06I', 24))
      call this.AddQuestItem(QuestItemTrain.create('u013', 6))
      call this.AddQuestItem(QuestItemTrain.create('h01K', 8))
