library QuestCrystalGolem requires QuestItemCaptureLegend, DalaranConfig, LegendLegion
  ...
  struct QuestBlueDragons extends QuestData
    private method RewardDescription takes nothing returns string
