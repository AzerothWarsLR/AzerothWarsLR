library QuestBlueDragons requires DalaranConfig, LegendNeutral, Display
  ...
  private function OnInit takes nothing returns nothing
    ...
    set tempQuest = QuestData.create("The Blue Dragonflight", "The Blue Dragons of Northrend are the wardens of magic on Azeroth. If their home in Northrend were to be captured, they might willingly join the mages of Dalaran.", "The Nexus has been captured. The Blue Dragonflight fights for Dalaran." , "ReplaceableTextures\\CommandButtons\\BTNBlueDragon.blp")
